...
import {  Plus, Star, ChevronRight, ChevronLeft } from 'lucide-react'
...
import {mockDocuments, currencySymbols} from '../MockData'

export function CourseDetails({ course: initialCourse, isEditing, onClose, onUpdate }: CourseDetailsProps) {
